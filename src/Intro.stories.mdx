...
<Story id="sub-components-panels-account--not-connected" height='220px' />
...
<Story id="sub-components-panels-account--connected" height='230px' />
...
And then you can instantiate the [Account sub-component](?path=/docs/sub-components-panels-account--not-connected)
