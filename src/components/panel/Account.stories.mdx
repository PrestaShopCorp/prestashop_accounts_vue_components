...
then go back to the module page that displayedthe component.
...
_Notice: If you need to integrate the standard behavior of PS Accounts, please see the `PsAccounts` component
in the integration section._

If you need a custom integration of PS Accounts components, here is the Account panel:
