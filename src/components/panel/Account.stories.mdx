...
<Story name='Not connected' height='220px'>
  {{
    ...
    template: '<Account :user="user" :isAdmin="isAdmin" :onboardingLink="onboardingLink" class="m-4" />',
  }}
</Story>
...
<Story name='Connected' height='230px'>
  {{
    ...
    template: '<Account :user="user" :isAdmin="isAdmin" :onboardingLink="onboardingLink" @sign-out="event" class="m-4" />',
  }}
</Story>
...
<Story name='Email validation needed' height='380px'>
  {{
    ...
    template: '<Account :user="user" :isAdmin="isAdmin" :onboardingLink="onboardingLink" @sign-out="event" @send-email="sendEmail" class="m-4" />',
  }}
</Story>
